 ...
 * @retval     #FIDO_ERROR_INVALID_PARAMETER  Invalid parameter
 */
EXPORT_API int fido_authenticator_foreach_attestation_type(const fido_authenticator_h auth, fido_attestation_type_cb cb, void *user_data);
 ...
 * @retval     #FIDO_ERROR_INVALID_PARAMETER  Invalid parameter
 */
EXPORT_API int fido_authenticator_get_verification_method(const fido_authenticator_h auth, fido_auth_user_verify_type_e *user_verification);
 ...
 * @retval     #FIDO_ERROR_INVALID_PARAMETER  Invalid parameter
 */
EXPORT_API int fido_authenticator_get_key_protection_method(const fido_authenticator_h auth, fido_auth_key_protection_type_e *key_protection);
 ...
 * @retval     #FIDO_ERROR_INVALID_PARAMETER  Invalid parameter
 */
EXPORT_API int fido_authenticator_get_matcher_protection_method(const fido_authenticator_h auth, fido_auth_matcher_protection_type_e *matcher_protection);
 ...
 * @retval     #FIDO_ERROR_INVALID_PARAMETER  Invalid parameter
 */
EXPORT_API int fido_authenticator_get_attachment_hint(const fido_authenticator_h auth, fido_auth_attachment_hint_e *attachment_hint);
 ...
 * @retval     #FIDO_ERROR_INVALID_PARAMETER  Invalid parameter
 */
EXPORT_API int fido_authenticator_get_tc_discplay(const fido_authenticator_h auth, fido_auth_tc_display_type_e *tc_display);
